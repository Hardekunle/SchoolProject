										...
										<div class="tab-content">
											<div class="tab-pane active" id="1">
												<div class="announcement-item">
													@if(!empty($announce))
													@foreach($announce->all() as $announce)
													<h5>{{$announce->subject}}<span class="new">New</span></h5>
													<h6><i class="fa fa-clock-o"></i>{{$announce->created_at}}</h6>
											...
											<div class="tab-pane" id="2">
													<div class="announcement-item">
														@if(!empty($announcem))
														@foreach($announcem->all() as $announcem)
															<h5>{{$announcem->subject}}<span class="new">New</span></h5>
															<h6><i class="fa fa-clock-o"></i>{{$announcem->created_at}}</h6>
															<p>{{$announcem->description}}</p>
														<div class="posted-by">
															<h6>{{$announcem->by}}</h6>
														</div>
														@endforeach
											...
											<div class="tab-pane" id="3">
													<div class="announcement-item">
														@if(!empty($announceme))
														@foreach($announceme->all() as $announceme)
															<h5>{{$announceme->subject}}<span class="new">New</span></h5>
															<h6><i class="fa fa-clock-o"></i>{{$announceme->created_at}}</h6>
															<p>{{$announceme->description}}</p>
														<div class="posted-by">
																<h6>{{$announceme->by}}</h6>
														</div>
														@endforeach
