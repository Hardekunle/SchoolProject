						...
						<div class="col-lg-12 clear-padding-xs">
							<div class="col-lg-12">
								<div class="dash-item first-dash-item">
                                    ...
                                    <form action="/timetable/view" method="post">
                                        @csrf
										<div class="col-sm-4">
											<label>CLASS</label>
											<select name="class">
							...
							<div class="col-lg-12">
								<div class="dash-item">
									<h6 class="item-title"><i class="fa fa-edit"></i>TIMETABLE</h6>
									<div class="inner-item">
                                        ...
                                        @foreach($post as $post)
												<tr>
													...
													<td>
                                                    @if($post->day=="Monday")
														<span><strong>{{$post->subject}}</strong></span>
                                                        <span><i>Teacher: {{$post->teacher}}</i></span>
                                                        @else
                                                        <span><strong>Not Set</strong></span>
                                                        <span><i>Teacher: Not Set</i></span>
                                                    @endif
                                                    </td>
													<td>
                                                    @if($post->day=="Tuesday")
										...
										<div class="table-action-box">
											<a href="#" class="save"><i class="fa fa-check"></i>DOWNLOAD</a>
											<a href="#" class="cancel"><i class="fa fa-ban"></i>PRINT</a>
										</div>
									</div>
								</div>
							</div>
